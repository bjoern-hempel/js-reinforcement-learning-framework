...
If we look at this example in the short term, it is a good idea to go through a1 (discountRate = 0): Because we always get a reward of 2 an we don't want to receive any punishment of -5. In the long run, it's better to go through a0 (discountRate = 0.9). Let's calculate that:  
