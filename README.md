...
var a0 = rl.addAction(s0, new StateChange(s0, 0.7,  10), new StateChange(s1, 0.3, 0));
var a1 = rl.addAction(s0, new StateChange(s0, 1.0,   0));
var a2 = rl.addAction(s0, new StateChange(s0, 0.8,   0), new StateChange(s1, 0.2, 0));
var a3 = rl.addAction(s1, new StateChange(s1, 1.0,   0));
var a4 = rl.addAction(s1, new StateChange(s2, 1.0, -50));
var a5 = rl.addAction(s2, new StateChange(s0, 0.8,  40), new StateChange(s1, 0.1, 0), new StateChange(s2, 0.1, 0));
